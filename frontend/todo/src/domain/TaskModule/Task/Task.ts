...
export class Task implements ITask {
    ...
    setDeadLine(newDeadLine: optionalStringField): this {
        ...
        this.deadLine = newDeadLine ? this.taskStrategy.parseBRDate(newDeadLine).toISOString() : newDeadLine;
        return this;
    }
    getStatus(): string {
        return this.status;
    ...
    setCreatedAt(newCreatedAt: string): this {
        ...
        this.createdAt = newCreatedAt ? this.taskStrategy.parseBRDate(newCreatedAt).toISOString() : newCreatedAt;
        return this;
    }
    ...
    setUpdatedAt(newUpdatedAt: optionalStringField): this {
        ...
        this.updatedAt = newUpdatedAt ? this.taskStrategy.parseBRDate(newUpdatedAt).toISOString() : newUpdatedAt;
        return this;
    }
    toJSON(): this {
        const copy = this;
